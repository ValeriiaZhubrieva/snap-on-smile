...
function initSliders() {
    ...
    const presentationSliders = document.querySelectorAll(".reviews__slider");
    if (presentationSliders.length)
        presentationSliders.forEach((slider) => {
            ...
            const swiperPagination = sliderParent.querySelector(".swiper-pagination");
            new Swiper(slider, {
                modules: [Navigation, Pagination],
                observer: true,
                observeParents: true,
...
document.addEventListener("click", (e) => {
    ...
    const videoBlock = document.querySelector(".video-block__body video");
    if (targetElement.closest(".video-block__play-btn")) {
        targetElement.closest(".video-block__body").classList.add("video-play");
